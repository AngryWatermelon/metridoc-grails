    ...
    def saveToDatabase(TreeMap<String, ArrayList<ArrayList<String>>> allInstances, String spreadsheetName, FlashScope flash) {
        ...
        if (consInstances) {
            for (ArrayList<String> instance in consInstances) {
                ...
                def t = new RidConsTransaction(
                        staffPennkey: instance.get(2),
                        userQuestion: instance.get(17),
                        ...
                        notes: instance.get(18),
                        facultySponsor: instance.get(15),
                        courseName: instance.get(12),
                        courseNumber: instance.get(14),
                        userName: instance.get(8),
